...
<div class="flex items-center justify-center w-full h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
    <div class="bg-gray-800 shadow-2xl rounded-lg p-8 max-w-md w-full border border-gray-700">
        ...
        <form class="space-y-6" action="{{ route('budget.cal') }}" method="post">
            @csrf
            <!-- Event Type -->
            <div>
                <label for="options" class="block text-sm font-medium text-gray-400">Select the Event Type</label>
                <select id="options" name="evtcat" class="mt-2 block w-full px-4 py-3 border border-gray-600 bg-gray-700 text-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150">
            ...
            <div>
                ...
                <input type="number" id="number1" name="evtmem" class="mt-2 block w-full px-4 py-3 bg-gray-700 border border-gray-600 text-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150 placeholder-gray-500" placeholder="Enter number here">
            </div>

            <!-- Number of Cameramen -->
            <div>
                <label for="number2" class="block text-sm font-medium text-gray-400">Number of cameramen you want</label>
                <input type="number" id="number2" name="evtcam" class="mt-2 block w-full px-4 py-3 bg-gray-700 border border-gray-600 text-gray-200 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150 placeholder-gray-500" placeholder="Enter number here">
            </div>
