    ...
    <div class="container mx-auto p-1 lg:w-3/4">
        ...
        <div class="w-full ">
            <div class="flex justify-between items-center   mb-4 ">
                <h2 class="lg:text-4xl font-bold text-yellow-500">Banner Page</h2>
        ...
        <div class="bg-gray-800 lg:p-7 p-3 rounded shadow-lg">
            <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data" class="space-y-10">
                ...
                <div>
                    ...
                    <input type="text" id="b_name" name="b_name" required placeholder="Enter banner name here.."
                ...
                <div>
                    <label for="status" class="block text-yellow-400 text-black text-xl font-medium mb-2">Status</label>
