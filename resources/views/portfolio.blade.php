...
<head>
    ...
    <title>Smart Studio | Portfolio</title>
...
<body class="bg-black roboto-medium">
  ...
  {{-- footer --}}
  <footer class=" w-full mt-10 py-8">
    <div class="flex flex-col sm:flex-row items-center justify-center gap-8 px-4">
       
        <div class="flex flex-col items-center text-center w-full sm:w-1/3">
            <img src="./images/user_profile.png" class="h-20 w-[120px] mb-5" alt="User profile image">
            <p class="text-white font-medium text-sm px-4">Lorem ipsum dolor, sit amet <br>consectetur adipisicing elit.<br> Nostrum hic, praesentiu</p>
        </div>
        
        {{-- insta --}}
        <div class="flex flex-col items-center w-full sm:w-1/3">
            <p class="uppercase text-xl text-white font-semibold mb-4">Insta Gallery</p>
            <div class="flex flex-wrap justify-center gap-4">
                <img src="./images/user_profile.png" alt="" class="h-20 w-20">
                <img src="./images/user_profile.png" alt="" class="h-20 w-20">
                <img src="./images/user_profile.png" alt="" class="h-20 w-20">
                <img src="./images/user_profile.png" alt="" class="h-20 w-20">
            </div>
       ...
       {{-- contact --}}
        <div class="flex flex-col items-center text-center w-full sm:w-1/3">
            <p class="uppercase text-xl text-white font-semibold mb-4">Contact</p>
            <p class="text-sm text-white mb-2">Phone: +91 9546805580</p>
            <p class="text-sm text-white mb-2">Email: smartstudio@gmail.com</p>
            <div class="flex space-x-4 mt-2">
                <a href="#"><img class="w-6 h-6" src="https://img.icons8.com/ios-filled/50/fac115/facebook-circled--v1.png" alt="Facebook icon"></a>
                <a href="#"><img class="w-6 h-6" src="https://img.icons8.com/glyph-neue/64/fac115/twitter-circled.png" alt="Twitter icon"></a>
                <a href="#"><img class="w-6 h-6" src="https://img.icons8.com/glyph-neue/64/fac115/linkedin-circled.png" alt="LinkedIn icon"></a>
            </div>
        </div>
    </div>
</footer>
