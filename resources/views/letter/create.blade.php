    ...
    <div class="max-w-3xl mx-auto p-6 bg-gray-800 shadow-lg rounded-lg">
        ...
        <form action="{{ route('letter.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="body" name="body" class="mt-2 p-3 w-full text-black border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
